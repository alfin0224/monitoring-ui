...
const EditSensor = () => {
  ...
  useEffect(()=>{
    const getSensorById = async () => {
      const response = await api.get(`/master-sensors/${id}`);
      setSensor(response.data.sensor);
      setSensorName(response.data.sensor_name);
  ...
  e.preventDefault();
    ...
    const sensorData = {
        ...
        unit: unit
            ...
            try {
                await api
                .put(`/master-sensors/${id}`, sensorData)
                .then((response) => {
                        ...
                        <div className="row">
                          <div className="col-lg-6 p-3">
                              <div className="form-group">
                                  ...
                                  <input value={sensor} onChange={e => setSensor(e.target.value)} className="form-control" required></input>
                              </div>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-lg-6 p-3">
                              <div className="form-group">
                                  ...
                                  <input value={sensorName} onChange={e => setSensorName(e.target.value)} className="form-control" required></input>
                              </div>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-lg-6 p-3">
                              <div className="form-group">
                                  ...
                                  <input value={unit} onChange={e => setUnit(e.target.value)} className="form-control" required></input>
                              </div>
                          </div>
                      </div>
                  </div>
